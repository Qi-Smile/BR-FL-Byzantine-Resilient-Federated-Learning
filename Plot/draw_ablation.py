...
if __name__ == '__main__':
    ...
    defense_list = ['Ours','ablation1','ablation2',]
    label_list = ['BR-FL','Client Defense Only', 'Server Defense Only',]
    ...
    save_name = 'Ablation_' + dataset_name + '_' + attack_name  + '.pdf'
    

    save_path = os.path.join('Plot_res', 'Ablation')
