...
if __name__ == '__main__':
    ...
    # dir_list = [0.25,1,5,1000]
    # defense_list = ['Ours','Avg',]
    # label_list = ['BR-FL','FedAvg',]
    ...
    # plt.subplots_adjust(left=0.13, right=1.0, top=0.99, bottom=0.13)
    ...
    save_name = dataset_name + '_' + attack_name + '_' + str(dirichlet_rate) + '.pdf'

    save_path = os.path.join('Plot_res', 'Dir')
